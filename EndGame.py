...
class EndGame:
    ...
    def show_win_screen(self, pygame_instance: 'pygame'):
        ...
        self._screen.blit(self._BG, (0, 0))
        print(congrats_rect)
        print(congrats_rect.width)
        self._screen.blit(self._BG.subsurface(congrats_rect), congrats_rect)
        self._screen.blit(congrats_surf, congrats_rect)
        press_key_surf: 'pygame.Surface' = self._key_font.render("Press any key to exit.", True, "#00fbfd")
    ...
    def show_wrong_answer_screen(self, pygame_instance: 'pygame'):
        ...
        Timer(2.0, self.show_end_screen).start()
    ...
    def show_end_screen(self):
        ...
        questions_answered_surf: 'pygame.Surface' = self._font.render(f"You answered a total of "
                                                        f"{self._questions.num + 1} questions correctly.", True, "cyan")
        press_key_surf: 'pygame.Surface' = self._font.render("Press any key to exit.", True, "cyan")
